...
class MetaFDMixup(MetaTemplate):
  ...
  def __init__(self, model_func,  n_way, n_support, tf_path=None):
    ...
    support_label = torch.zeros(self.n_way*self.n_support, self.n_way).scatter(1, support_label.long(), 1).view(self.n_way, self.n_support, self.n_way)
  ...
  def set_forward_loss_for_train(self, x_1, x_2):
        ...
        loss_FSL_1 = self.loss_fn(scores_FSL_1, y_query_1.long())
        loss_FSL_2 = self.loss_fn(scores_FSL_2, y_query_2.long())
